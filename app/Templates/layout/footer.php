<footer class="container">
    <div class="flex py-5 flex-col md:flex-row items-center justify-between">
        ...
        <a href="<?= url() ?>" class="flex items-center justify-center text-accent-400 my-3 md:my-0">
            ...
            <span class="font-semibold text-lg ml-2"><?= _e(cms('title', 'CoPlay')) ?></span>
        </a>
        <p class="text-xs">
    ...
    <div class="text-center mb-6">
        <p class="text-xs text-primary-400 opacity-75">
            <?= _e(cms('disclaimer', 'We does not host any files, it merely links to 3rd party services. CoPlay is not responsible for any media files shown by the video providers')) ?>
        </p>
    </div>
</footer>